...
export const n7x: Car = {
  ...
  variants: [
    {
      ...
      features: [
        ...
        '17-inch Alloy Wheels N7X Design',
  ...
  specs: {
    ...
    features: {
      exterior: ['N7X Exclusive Body Kit', 'LED Headlights dengan DRL', '17-inch N7X Alloy Wheels', 'Roof Rail', 'Front Fog Lamps', 'Remote Engine Start'],
      interior: ['7-inch Touchscreen Display Audio', 'Leather Seats (Prestige)', '60:40 Split Fold 3rd Row', 'Auto AC Dual Zone (Prestige)', 'Remote Engine Start'],
