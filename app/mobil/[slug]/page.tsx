...
import TestDriveCTA from '@/components/cars/TestDriveCTA';
import SpecificationHighlights from '@/components/cars/SpecificationHighlights';
...
export default async function CarDetailPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <SpecificationHighlights specs={car.specs} />
