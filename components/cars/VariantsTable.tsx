...
export default function VariantsTable({ variants, carName }: VariantsTableProps) {
  ...
  return (
    <section id="variants" className="bg-linear-to-br from-gray-50 to-white py-8">
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 items-end">
            ...
            <div>
              <a
                ...
                className="w-full bg-linear-to-r from-green-500 to-green-600 text-white px-4 py-3 rounded-lg font-bold text-base hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 flex items-center justify-center gap-2"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {variants.map((variant, index) => (
            ...
            >
              {/* Variant Header */}
              <div className="bg-linear-to-r from-gray-900 to-gray-800 text-white p-4 rounded-t-xl">
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2 mt-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-linear-to-r from-green-500 to-green-600 text-white text-center py-2 rounded-lg font-semibold hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-sm hover:shadow-md text-xs"
                  >
                    Chat WhatsApp
                  </a>
                  <a
