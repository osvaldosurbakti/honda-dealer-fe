      ...
      <div className="bg-linear-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-gray-700/50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-2 relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-center text-xs">
            ...
            <div className="flex items-center space-x-6 mb-2 lg:mb-0">
              {/* Phone */}
              <div className="flex items-center space-x-2 group">
                ...
                <a 
                  ...
                  className="text-white/90 hover:text-white transition-all font-medium hover:underline"
                >
              ...
              <div className="hidden md:flex items-center space-x-2 group">
                ...
                <a 
                  ...
                  className="text-white/90 hover:text-white transition-all hover:underline"
                >
              ...
              <div className="flex space-x-2">
                {contactInfo.socialMedia.tiktok && (
                  <a 
                    ...
                    className="w-7 h-7 bg-white/10 rounded-full flex items-center justify-center hover:bg-honda-red transition-all group border border-white/20 hover:border-honda-red"
                  >
                ...
                {contactInfo.socialMedia.facebook && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-7 h-7 bg-white/10 rounded-full flex items-center justify-center hover:bg-blue-600 transition-all group border border-white/20 hover:border-blue-600"
                  >
                ...
                {contactInfo.socialMedia.instagram && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-7 h-7 bg-white/10 rounded-full flex items-center justify-center hover:bg-pink-600 transition-all group border border-white/20 hover:border-pink-600"
                  >
...
<div className="relative w-14 h-14 bg-gradient-to-br from-honda-red to-red-600 rounded-2xl flex items-center justify-center shadow-2xl group-hover:shadow-3xl transition-all duration-500 border-2 border-white overflow-hidden">
  ...
  <Image
    ...
    width={32}
    height={32}
    className="object-contain filter brightness-0 invert relative z-10 group-hover:scale-110 transition-transform duration-300"
    priority
  />
</div>
              ...
              <div className="hidden sm:block">
                <h1 className="text-2xl font-bold text-gray-900 tracking-tight bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text">
                  {siteConfig.company.name}
                </h1>
                <div className="flex items-center space-x-2 mt-1">
                  <FaMedal className="text-honda-red w-4 h-4" />
                  <p className="text-sm text-gray-600 font-semibold">Authorized Honda Dealer</p>
                </div>
              </div>
            </Link>
            ...
            {/* Mobile menu button */}
            <button
              className="lg:hidden p-3 rounded-xl bg-linear-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 transition-all duration-300 shadow-lg border border-gray-200/60"
          ...
          {/* Mobile Navigation */}
          {isMenuOpen && (
            <div className="lg:hidden py-6 border-t border-gray-200/60 bg-white/95 backdrop-blur-xl rounded-2xl mt-2 shadow-2xl border">
              {/* Mobile Stats */}
              ...
              <nav className="flex flex-col space-y-3">
                {navigation.map((item) => (
                  <Link
                    key={item.name}
                    href={item.href}
                    className={`flex items-center space-x-4 px-6 py-4 rounded-xl font-semibold transition-all duration-300 group border ${
                      activeNav === item.href
                  ...
                  >
                    ...
                    <div className={`w-2 h-2 bg-honda-red rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
              ...
              <div className="flex flex-col space-y-3 mt-6 px-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-linear-to-r from-green-500 to-green-600 text-white px-6 py-4 rounded-xl font-semibold hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-lg text-center flex items-center justify-center space-x-3"
